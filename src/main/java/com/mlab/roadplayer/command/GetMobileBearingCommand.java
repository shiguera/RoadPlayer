...
public class GetMobileBearingCommand extends GetValueCommand {

	public GetMobileBearingCommand(TrackMapModel model) {
		super(model);
	}
	...
	public String getValue() {
		...
		if(wp!=null && AndroidWayPoint.class.isAssignableFrom(wp.getClass())) {
			...
			builder.append(Util.doubleToString(((AndroidWayPoint)wp).getBearing(), 4, 1));
